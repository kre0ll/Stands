...
namespace Stands.WebRole.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
              var user = db.AspNetUsers.FirstOrDefault(item => item.Email.Equals(model.Email));
              userId = user.Id;
            }
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            {
                case SignInStatus.Success:
                    return RedirectToLocal(Guid.Empty);
                case SignInStatus.LockedOut:
                    return View("Lockout");
                case SignInStatus.Failure:
                default:
        ...
        private ActionResult RedirectToLocal(Guid id)
        {
            ApplicationUserManager userManager = HttpContext.GetOwinContext()
                                            .GetUserManager<ApplicationUserManager>();

            bool isAdmin = userManager.GetRoles(id).Contains("Admin");
